...
- Added explicit public version tracking to the repo docs.
- Separated the release story from the roadmap so each version can be logged clearly.
- Marked `1.1` as the current public tracked version.

Notes:

- Future versions should add a short entry here with the visible changes and the reason they matter.
- Keep the log sanitized and avoid private path details.
...
- Introduced the public ManagedFolders mirror as a self-contained management system.
- Published the initial roadmap and public-safe documentation shape.

...
- `2.2` is the current public tracked operating-model release.
...
- Current public release note: [`2.2.md`](2.2.md)
...
Use `release-template.md` for new release notes. The repo-local release note is the source text; a GitHub Release can reuse that text later.
